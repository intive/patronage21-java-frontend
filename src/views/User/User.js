...
import {
    USER_BIO_TITLE,
    USER_CONTACT_BUTTON_GITHUB, USER_CONTACT_BUTTON_MAIL,
            ...
            <Box my={5}>
                <Grid container spacing={3}>
                    ...
                    <ListGroup groupTitle={USER_CONTACT_TITLE}>
                        <ContactItem contact={user.email} text={USER_CONTACT_BUTTON_MAIL} divider={true}/>
                        <ContactItem contact={user.phone} text={USER_CONTACT_BUTTON_PHONE} divider={true}/>
                        <ContactItem contact={user.github} text={USER_CONTACT_BUTTON_GITHUB} divider={false}/>
                    </ListGroup>
                </Grid>
            </Box>
        </>
